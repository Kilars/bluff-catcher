/**
 * Flop texture in five buckets. Nothing here looks at a hole card — texture is
 * what you read *before* your own hand.
 *
 * "mine" and "theirs" are written from the preflop raiser's seat and do not
 * flip when Hero is the caller: read `middling-theirs` as "favours whoever
 * called".
 */
...
/**
 * Classify a flop; null if fewer than three cards were dealt.
 *
 * Precedence matters: a paired monotone flop is reported as monotone, because
 * the flush is what changes how the hand plays.
 */
